...
import 'package:green_taxi_mine/views/driver/car_registration/pages/document_uploaded_page.dart';
import 'package:green_taxi_mine/views/driver/car_registration/pages/location_page.dart';
import 'package:green_taxi_mine/views/driver/car_registration/pages/upload_document_page.dart';
import 'package:green_taxi_mine/views/driver/car_registration/pages/vehical_color_page.dart';
import 'package:green_taxi_mine/views/driver/car_registration/pages/vehical_make.dart';
import 'package:green_taxi_mine/views/driver/car_registration/pages/vehical_model_page.dart';
import 'package:green_taxi_mine/views/driver/car_registration/pages/vehical_model_year_page.dart';
import 'package:green_taxi_mine/views/driver/car_registration/pages/vehical_number_page.dart';
import 'package:green_taxi_mine/views/driver/car_registration/pages/vehical_type_page.dart';
...
class _CarRegistrationTemplateState extends State<CarRegistrationTemplate> {
          ...
          Expanded(child: Padding(
            ...
            child: PageView(
              ...
              children: [
                ...
                UploadDocumentPage(onImageSelected: (List<File> images){
                  document = images;
                },),
  ...
  void uploadDriverCarEntry() async{
    ...
    isUploading(true);
    List<String> imageUrls = await Get.find<AuthController>().uploadMultipleImages(document!);
